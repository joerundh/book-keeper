...
export default function Header() {
    ...
    return (
        <header style={styles.header}>
            <DropDownMenu title="Menu" closedIcon="./menu-icon.png" openIcon="./close-icon.png" side="left">
            ...
            <DropDownMenu title="Profile" closedIcon="./profile-icon.png" openIcon="./close-icon.png" side="right">
